class Asyncy < Formula
  ...
  resource "click-alias" do
    url "https://pypi.python.org/packages/source/c/click-alias/click-alias-0.1.1a1.tar.gz"
  ...
  resource "click-help-colors" do
    url "https://pypi.python.org/packages/source/c/click-help-colors/click-help-colors-0.4.tar.gz"
  ...
  resource "lark-parser" do
    url "https://pypi.python.org/packages/source/l/lark-parser/lark-parser-0.6.3.tar.gz"
  ...
  resource "storyscript" do
    url "https://pypi.python.org/packages/source/s/storyscript/storyscript-0.4.1.tar.gz"
